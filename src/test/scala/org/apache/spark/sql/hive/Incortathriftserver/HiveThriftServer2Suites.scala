...
abstract class HiveThriftServer2Test extends SparkFunSuite with BeforeAndAfterAll with Logging {
  ...
  protected val startScript = "../../spark-2.4.0-bin-hadoop2.7/sbin/start-thriftserver.sh".split("/").mkString(File.separator)
  protected val stopScript = "../../spark-2.4.0-bin-hadoop2.7/sbin/stop-thriftserver.sh".split("/").mkString(File.separator)

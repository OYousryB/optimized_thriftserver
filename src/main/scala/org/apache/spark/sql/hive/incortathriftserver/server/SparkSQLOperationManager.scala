...
import org.apache.spark.sql.hive.incortathriftserver.{ReflectionUtils, SparkExecuteStatementOperation}
import org.apache.spark.sql.internal.SQLConf

/**
 * Executes queries using Spark SQL, and maintains a list of handles to active queries.
 */
private[incortathriftserver] class SparkSQLOperationManager()
